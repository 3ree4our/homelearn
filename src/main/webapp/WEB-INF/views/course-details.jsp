            ...
            <div class="col-lg-8">
                ...
                <div class="comment-form">
                    ...
                    <form action="writeReview" method="post">
                        ...
                        <button class="btn btn-filled btn-round ml-auto" type="button" onclick="writeReview()"><span class="bh"></span>
                            <span>전송</span></button>
                    </form>
                </div>
            ...
            <div class="col-lg-4">
                <aside class="sidebar">
                    <div class="widget buy-course">
                        <p class="price"><strong>$<%=course.getPrice()%></strong></p>
    ...
    data: {content: $("#content").val(), url: url},
          success: function (data) {
            ...
            for (let i =0; i<result.length; i++){
              ...
              // 시간 일단 빼기 html += ` <span>닉네임:</span><span>\${data[i].created_at}</span>`;

              //   html += ` <span>작성일:</span><span>\${dat}</span>`;
