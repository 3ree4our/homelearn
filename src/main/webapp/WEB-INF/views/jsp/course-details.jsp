        ...
        <aside class="sidebar">
          ...
          <div class="widget recent-courses">
            ...
            <ul>
              <li>
                <a href="#">
                  <img src="${pageContext.request.contextPath}/resources/images/chapters/3.jpg"
                       alt="">
                  <h5>David Kymen</h5>
              ...
              <li>
                <a href="#">
                  <img src="${pageContext.request.contextPath}/resources/images/chapters/4.jpg"
                       alt="">
                  <h5>Jessi Green</h5>
              ...
              <li>
                <a href="#">
                  <img src="${pageContext.request.contextPath}/resources/images/chapters/1.jpg"
                       alt="">
                  <h5>Adam wood</h5>
