package org.threefour.homelearn.aop;
...
import static org.threefour.homelearn.util.LogConstant.PERFORMANCE_MEASUREMENT;
...
public class LoggingAspect {
    ...
    private static final String LOGGING_EXECUTION_POINTCUT
            = "execution(* org.threefour.homelearn..service.*.*(..))";
